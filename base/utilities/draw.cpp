...
void D::Setup(IDirect3DDevice9* pDevice, unsigned int uFontFlags)
{
	...
	colors[ImGuiCol_TextSelectedBg] = ImVec4(0.50f, 0.50f, 0.50f, 1.00f);
	colors[ImGuiCol_Text] = ImVec4(0.8f, 0.8f, 0.8f, 1.00f);
	colors[ImGuiCol_TextDisabled] = ImVec4(0.50f, 0.50f, 0.50f, 1.00f);
	colors[ImGuiCol_WindowBg] = ImVec4(0.06f, 0.06f, 0.06f, 0);
	colors[ImGuiCol_ChildBg] = ImVec4(0.00f, 0.00f, 0.00f, 0.00f);
	colors[ImGuiCol_PopupBg] = ImVec4(0.08f, 0.08f, 0.08f, 0);
	colors[ImGuiCol_Border] = ImVec4(0.43f, 0.43f, 0.50f, 0.f);
	colors[ImGuiCol_BorderShadow] = ImVec4(0.00f, 0.00f, 0.00f, 0.00f);
	colors[ImGuiCol_FrameBg] = ImVec4(0.127f, 0.127f, 0.127f, 0.0f);
	colors[ImGuiCol_FrameBgHovered] = ImVec4(0.127f, 0.127f, 0.127f, 0);
	colors[ImGuiCol_FrameBgActive] = ImVec4(0.127f, 0.127f, 0.127f, 0);
	colors[ImGuiCol_TitleBg] = ImVec4(0.04f, 0.04f, 0.04f, 0);
	colors[ImGuiCol_TitleBgActive] = ImVec4(0.50f, 0.50f, 0.50f, 0);
	colors[ImGuiCol_TitleBgCollapsed] = ImVec4(0.00f, 0.00f, 0.00f, 0);
	colors[ImGuiCol_MenuBarBg] = ImVec4(0.14f, 0.14f, 0.14f, 0);
	colors[ImGuiCol_ScrollbarBg] = ImVec4(0.02f, 0.02f, 0.02f, 0);
	colors[ImGuiCol_ScrollbarGrab] = ImVec4(0.31f, 0.31f, 0.31f, 0);
	colors[ImGuiCol_ScrollbarGrabHovered] = ImVec4(0.41f, 0.41f, 0.41f, 0);
	colors[ImGuiCol_ScrollbarGrabActive] = ImVec4(0.51f, 0.51f, 0.51f, 0);
	...
	colors[ImGuiCol_HeaderHovered] = ImVec4(0.127f, 0.127f, 0.127f, 0.80f);
	...
	colors[ImGuiCol_TextSelectedBg] = ImVec4(0.92f, 0.14f, 0.45f, 0.4f);
